...
export const getDropdownListHandler = <Value = string>(setValue: ValueSetter<Value>, isValueValid: (value:string|Value) => value is Value): SelectChangeEventHandler<Value> => {
