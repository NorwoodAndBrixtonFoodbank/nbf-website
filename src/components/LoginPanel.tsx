...
const MiddleDiv = styled.div`
    max-width: 400px;
    box-shadow: 0px 0px 15px ${(props) => props.theme.surface.background[0]};
    border-radius: 10px;
    padding: 50px;
    margin: auto;
    ...
    & input {
        border-color: ${(props) => props.theme.surface.background[0]};
    ...
    & input:-webkit-autofill:active {
        // background-color: ${(props) => props.theme.main.background[1]} !important;
        transition: background-color 99999s ease-in-out 0s;
        -webkit-text-fill-color: ${(props) => props.theme.main.foreground[0]} !important;
    }
