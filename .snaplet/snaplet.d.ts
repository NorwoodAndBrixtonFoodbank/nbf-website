...
interface Table_public_collection_centres {
  name: string;
  acronym: string;
  primary_key: string;
}
...
interface Table_public_families {
  family_id: string;
  primary_key: string;
  gender: Enum_public_gender;
  age: number | null;
}
...
interface Table_public_lists_hotel {
  primary_key: string;
  item_name: string;
  row_order: number;
  notes_for_1: string | null;
